...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/zhyfv58gq-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-b852fc360e.ui48.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-b852fc360e.ui48.p3.openshiftapps.com}
